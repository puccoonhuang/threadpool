...
#ifndef TP_HAVE_CLOCK_GETTIME
	#if (defined(_POSIX_TIMERS) && defined(CLOCK_REALTIME)) || defined(TP_VXWORKS) || defined(__QNX__)
		#ifndef __APPLE__ // See GitHub issue #1453 - not available before Mac OS 10.12/iOS 10
			#define TP_HAVE_CLOCK_GETTIME
		#endif
	#endif
#endif


#if defined(_WIN32_WCE) && defined(TP_WINCE_TIMESTAMP_HACK)
...
#endif // defined(_WIN32_WCE) && defined(TP_WINCE_TIMESTAMP_HACK)
...
{
#if defined(TP_OS_FAMILY_WINDOWS)
...
#elif defined(TP_HAVE_CLOCK_GETTIME)
