...
#ifndef ErrorHandler_INCLUDED
#define ErrorHandler_INCLUDED
...
public:
	...
	virtual void exception(const Exception& exc);
		/// Called when a TP::Exception (or a subclass)
	...
	virtual void exception();
		...
		/// TP::Exception nor a std::exception caused
